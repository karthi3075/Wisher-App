...
export default function Wish(){
    ...
    const handleNo = () => {
        setNo(true)
        setYes(false)
        setMsg("Poi Yes Click Pannu")
    }
    const handleYes = () => {
        setYes(true);
        setNo(false)
        setMsg("Give Me The Treat")
    }
            ...
            <div className="flex justify-center flex-col items-center w-screem h-screen">
                ...
                <div className="bg-blue-300 p-5 rounded text-white">
                    <div className=" text-center font-bold">
                        <h1 className="text-3xl bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 bg-[length:200% 200%] bg-clip-text text-transparent animate-gradient animate-pulse">Happy Birth Day</h1>
                        <h3 className="text-2xl mt-3  bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 bg-[length:200% 200%] bg-clip-text text-transparent animate-gradient animate-pulse">Friend</h3>
                    </div>
                    <div className="mt-4">
